...
-- Généré le :  Jeu 16 Janvier 2020 à 09:05
...
(84, 3, '5', 2020, 1, 7, '2020-01-20', '2020-01-21', 10, 'Sharepoint admin', 'Automatisation d\'outils de création de tableau détaillant les bits des registres pour les RM (reference manual) pour la division MDG. Support pour la maintenant de l\'intranet, des workspace et des docshares. Support pour la migration de l\'intranet, des workspaces et des docshares de la division MDG et ses sous divisions vers Office 365. ', 'Zone Industrielle, 190 Avenue Coq, 13106 Rousset', 'bilalbechari@st.com', NULL, NULL, './public/2020/5A/2020_5A_BECHARI_Bilal_presentation.pdf', '2020-01-15 23:00:00', './public/2020/5A/2020_5A_BECHARI_Bilal_evaluation.pdf', '2020-01-16 07:53:12', '2020-01-15 18:20:48', 0, '2020-01-30', '2020-01-31', '2020-02-25', '2020-01-15 17:44:20', './public/2020/5A/2020_5A_BECHARI_Bilal_competences.pdf');
...
(1, 'BERGONZI', 'Ludovic', 'bilal.bechari@etu.univ-amu.fr', 10, '0aa41b6c2f75abc64c93636bd5094cb3c22e852acd277dc20982720f3a5f252464f2c1a0ae3f9c11d07c325a60932a6bfdf9211b30c8c583c0fcffd2dfde6121'),
...
(4, 'NATALI', 'Mathieu', 'isabelle.gumos@etu.univ-amu.fr', 47, '7c4a920cee3926f1acbc2a0f06cbb834c8a88482bef9cb0721eb2812b368d6f71ebd8a24e9558a4e47e278c4048d409572ebdf6b939ce56f66d9b9035476bcd1'),
...
--
ALTER TABLE `entreprise`
  MODIFY `identreprise` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
--
...
--
ALTER TABLE `stage`
  MODIFY `idstage` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
--
